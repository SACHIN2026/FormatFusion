...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 bg-muted/40 -mx-4">
        ...
        <div className="max-w-3xl mx-auto grid md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="text-muted-foreground">Drag & drop or browse to select the image you want to convert.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">Select your desired output format and adjust quality settings.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">Get your converted image instantly, ready to use.</p>
          </div>
        </div>
      </section>
