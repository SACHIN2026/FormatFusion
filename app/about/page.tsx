      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border space-y-6">
        <section>
          ...
          <p className="text-gray-700">
            FormatFusion was created with a simple mission: to provide a fast, free, and easy-to-use tool for converting images between different formats. We believe that powerful image conversion tools should be accessible to everyone, without requiring technical knowledge or expensive software.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-gray-700">
            All processing is done securely, and we never store your images permanently.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-3">
            <div className="p-3 bg-gray-50 rounded">
              ...
              <p className="text-sm text-gray-700">Best for photographs and complex images with many colors. Offers good compression but is lossy.</p>
            </div>
            <div className="p-3 bg-gray-50 rounded">
              <h3 className="font-medium mb-1">PNG</h3>
              <p className="text-sm text-gray-700">Supports transparency and is lossless. Ideal for graphics, logos, and images with text.</p>
            </div>
            <div className="p-3 bg-gray-50 rounded">
              <h3 className="font-medium mb-1">WebP</h3>
              <p className="text-sm text-gray-700">Modern format developed by Google that offers superior compression and quality. Supports transparency.</p>
            </div>
            <div className="p-3 bg-gray-50 rounded">
              <h3 className="font-medium mb-1">AVIF</h3>
              <p className="text-sm text-gray-700">Next-generation format with excellent compression and quality. Growing browser support.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            Have questions or suggestions? We'd love to hear from you at contact@imageconverter.com.
          </p>
        </section>
      </div>
    </main>
