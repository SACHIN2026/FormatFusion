        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6">
              <div className="h-12 w-12 bg-secondary rounded-lg flex items-center justify-center mx-auto mb-4">
                <svg className="h-6 w-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2">AI-Powered</h3>
              <p className="text-muted-foreground">Advanced AI technology automatically detects and removes backgrounds with precision.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">Your images are processed securely and deleted automatically after processing.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">Get professional-quality results with clean edges and transparent backgrounds.</p>
            </div>
          </div>
        </div>
      </section>
